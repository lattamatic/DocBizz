...
public class SentReferralRecyclerViewAdapter extends RecyclerView.Adapter<SentReferralRecyclerViewAdapter.ListItemViewHolder>{

    private ArrayList<ReferralItem> items;
    private Context context;

    public SentReferralRecyclerViewAdapter(ArrayList<ReferralItem> items, Context context) {
        this.items = items;
